<html lang="en">
    <head>
        ...
        <title>Admin Active Users || MUNCHBOX - The Foodies Food</title>
        <?php
                        ...
                        <div class="col-sm-12">
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">Manage Active Users</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- end .page title-->
                                ...
                                <div class="panel-body">
                                    <table id="basic-datatables" class="table table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $c = 0;
                                            foreach ($user_detail as $activeuser) {
                                                $c++;
                                                ?>
                                                <tr>
                                                    <td><?php echo $c; ?></td>
...
<a onclick="$('#activeuser').attr('href','<?php echo base_url(); ?>Active-Deactive/activeuser/<?php echo $activeuser->user_id; ?>')" 
data-toggle="modal" data-target=".bs-example-modal-md">
