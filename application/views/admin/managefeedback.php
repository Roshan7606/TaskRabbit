<html lang="en">
    <head>
        ...
        <title>Admin Manage Feedback || MUNCHBOX - The Foodies Food</title>
        <?php
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Manage Feedback Data<small></small></h1>
                                <ol class="breadcrumb">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-card ">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Manage Feedback Data</h4>
                                        ...
                                        <tbody>
                                            ...
                                            foreach($feedback as $single) 
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a onclick="$('#feedback_del').attr('href', '<?php echo base_url(); ?>Remove/feedback/<?php echo $single->feedback_id; ?>')"  itle="Delete" data-toggle="modal" data-target=".bs-example-modal-md"><i class="fas fa-trash-alt text-danger"></i> </a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content" style="padding: 30px;">
                    <center>
                        ...
                        <a id="feedback_del" class="btn btn-danger" style="padding:10px 40px;">Yes</a>
