...
<html lang="en">
    <head>
        ...
        <title>Munchbox | Restaurant Restaurant-Active-Review</title>
        <?php
                        ...
                        <div class="page-header">
                            ...
                            <div class="header-sub-title">
                                <nav class="breadcrumb breadcrumb-dash">
                                    ...
                                    <span class="breadcrumb-item active">Active Review</span>
                                </nav>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="row m-b-30">
                                            <div class="col-lg-5 text-left">
                                                <h2 class="head-table-text">Restaurant Active Review</h2>
                                            </div>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table table-hover e-commerce-table">
                                                ...
                                                <tbody class="text-center">
                                                    <?php
                                                    $c=0;
                                                    foreach($active_review as $activereview){
                                                        $c++;
                                                        ?>
                                                        <tr>
                                                            <td><?php echo $c; ?></td>
                                                            <td>John Shah</td>
                                                            <td>MUNCHBOX</td>
                                                            <td><?php echo $activereview->review; ?></td>
                                                            <td>25-01-2020</td>
                                                            <td class="text-center">
                                                                <a onclick="$('#activerestaurant').attr('href', '<?php echo base_url(); ?>Active-Deactive/deactiverestaurant/<?php echo $activereview->review_id; ?>')" title="Deactive Review" data-toggle="modal" data-target=".bs-example-modal-md" class="btn btn-icon btn-anticon-hover btn-hover btn-sm btn-rounded pull-right">
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content" style="padding: 30px;">
                    <center>
                        ...
                        <a id="activerestaurant" href="#"   class="btn btn-danger" style="padding:10px 40px;">Yes</a>
